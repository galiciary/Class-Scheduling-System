...
```
src/
├── app/           Next.js App Router entry: layout, page, and global styles
├── components/
│   ├── course/    Course list, course card, and section row
│   ├── filters/   Search box and filter panel
│   ├── schedule/  Timetable grid, mobile day list, and class block
│   └── ui/        Shared UI components
├── hooks/         Catalog loading and schedule selection
├── lib/           Framework-free logic: timetable, conflicts, filtering, time, colors, storage
├── types/         Domain types
